...
<table class="bwwc-payment-instructions-table" id="bwwc-payment-instructions-table">
  ...
  <tr class="bpit-table-row">
	...
	<a href="bitcoin:{{{BITCOINS_ADDRESS}}}?sv&req-sv&amount={{{BITCOINS_AMOUNT}}}"><img src="https://api.qrserver.com/v1/create-qr-code/?data=bitcoin:{{{BITCOINS_ADDRESS}}}?amount={{{BITCOINS_AMOUNT}}}" style="vertical-align:middle;border:1px solid #888;" /></a>
      </div>
    </td>
  </tr>
</table>
